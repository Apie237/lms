...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center w-full md:pt-36 pt-20 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
      ...
      courses designed<span className='text-blue-600'>to fit your choice.<img src={assets.sketch} alt='sketch' className='md:block hidden absolute -botton-7 right-0'/></span></h1>
