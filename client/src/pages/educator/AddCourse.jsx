...
const AddCourse = () => {
  ...
  return (
    <div className="h-screen overflow-auto flex flex-col items-center justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0">
      <form onSubmit={handleSubmit} className="w-full max-w-4xl">
        <div className="flex flex-col gap-1 mb-4">
          ...
          <input
            ...
            className="outline-none md:py-2.5 px-3 py-2 rounded border border-gray-500 required"
            type="text"
          />
        </div>
        ...
        <div className="flex items-center justify-between flex-wrap mb-4">
          ...
          <div className="flex md:flex-row flex-col items-center gap-3">
            ...
            <label htmlFor="thumbnailImage" className="flex items-center gap-3">
              ...
              {image && <img src={URL.createObjectURL(image)} alt="" className="h-16 w-16 object-cover" />}
            </label>
          </div>
        </div>
        ...
        <div>
          ...
          {/* Popup for adding lecture details */}
          {showPopup && (
